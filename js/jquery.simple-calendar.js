...
; (function ($, window, document, undefined) {
    ...
    var pluginName = "simpleCalendar",
        defaults = {
            months: [ 'march'], //string of months starting from january
            days: ['sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday'], //string of days starting from sunday
            minDate: "2020-03-01", // minimum date
            maxDate: "2020-03-31", // maximum date
...
//            fixedStartDay: true, // Week begin always by monday
    ...
    $.extend(Plugin.prototype, {
        ...
        buildCalendar: function (fromDate, calendar) {
            ...
            var eventContainer = $('<div class="event-container"><p class="event-date">Mar 01, 2020</p><h2 class="title">Event Name</h2><a href="#" class="close"></div>');
